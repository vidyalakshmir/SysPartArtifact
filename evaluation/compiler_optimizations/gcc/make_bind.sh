...
LDFLAGS=-Wl,-rpath,$BASEDIR/binaries/libuv/1/libuv-1.34.0/install/lib ./configure --without-libxml2 --prefix=$BASEDIR/binaries/bind/1 
make -j 8
make install
cd ../
rm -rf bind9
...
LDFLAGS=-Wl,-rpath,$BASEDIR/binaries/libuv/2/libuv-1.34.0/install/lib ./configure --without-libxml2 --prefix=$BASEDIR/binaries/bind/2 
make -j 8
make install
cd ../
rm -rf bind9
...
LDFLAGS=-Wl,-rpath,$BASEDIR/binaries/libuv/3/libuv-1.34.0/install/lib ./configure --without-libxml2 --prefix=$BASEDIR/binaries/bind/3
make -j 8
make install
cd ../
rm -rf bind9
